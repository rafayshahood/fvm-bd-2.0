    ...
    def __init__(self, config, ed, vae, net, fp16):
        ...
        if self.net=='ed':
            try:
                ...
                self.checkpoint_ed = torch.load(f'GenConViT/weight/{ed}.pth', map_location=torch.device('cpu'))
            ...
            try:
                ...
                self.checkpoint_vae = torch.load(f'GenConViT/weight/{vae}.pth', map_location=torch.device('cpu'))
